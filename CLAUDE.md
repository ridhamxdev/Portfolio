...
When relevant, use these skills (available in the Claude marketplace):

- `frontend-design` — production-grade UI components
- `ui-ux-pro-max` — visual style decisions, palettes, product-type-specific patterns
- `theme-factory` — quick-start themes for landings, dashboards, slides
- `webapp-testing` — verify the site works in a real browser before declaring it done
...
2. **Setup** — install Claude desktop, install design skills, add Motion as a dependency
