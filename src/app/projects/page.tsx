  ...
  return (
    <main className="relative z-10 mx-auto max-w-[1400px] px-5 pb-32 pt-36 sm:px-8">
      <header className="mb-12 max-w-3xl">
        <p className="eyebrow mb-6">[ The work — 17 projects ]</p>
        ...
        <p className="mt-6 max-w-xl text-lg leading-relaxed text-muted">
          Drag through the gallery to browse, or scan the full index below.
          Eleven of these are deployed and clickable right now.
        </p>
      </header>
